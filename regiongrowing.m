        ...
        if I(rs,cs)==1 && mask(rs,cs)==0;
            ...
            if size(A,1)<cluster_size
               ...
               objid=objid-1;
                ...
                if ((abs(round-1)<0.75 | Area>5*cluster_size)  & compactness > 0.55) % 0.1 wäre weniger rund als 0.01 usw.
                    ...
                    results(objid,5)=round; % habs jetzt auch noch als parameter angefügt
                else 
